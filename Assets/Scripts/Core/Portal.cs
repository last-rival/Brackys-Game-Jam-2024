...
public class Portal : MonoBehaviour
{
    ...
    void OnDrawGizmos()
    {
        ...
        var linkedPos = linkedPortal.transform.position;
        var dir = linkedPos - pos;
        Handles.color = Color.white;
        Handles.DrawLine(pos + Vector3.up, linkedPos + Vector3.up);
        Handles.color = Color.cyan;
        Handles.ArrowHandleCap(0, transform.position + Vector3.up, Quaternion.LookRotation(dir, transform.up), 1, EventType.Repaint);
    }
#endif
